import { LedgerVapory, NodeLedgerConnectionFactory, Network } from '../source/index';
...
async function doStuff() {
	...
	const ledgerVapory = new LedgerVapory(Network.Main, NodeLedgerConnectionFactory, onConnectLedgerRequest, onOpenVaporyAppRequest, onSwitchLedgerModeRequest, onEnableContractSupportRequest);
